...
import day20_arrays.C04_ArrayElementEkleme;
...
public class C03_ArrayeYeniDegerAtama {
    public static void main(String[] args) {
        ...
        sayilar = C04_ArrayElementEkleme.arrayElementEkleme(sayilar,3);
        System.out.println(Arrays.toString(sayilar)); // [4, 2, 1, 3]
        // sayilar array'ine 5.element olarak 9 ekleyin
        sayilar = C04_ArrayElementEkleme.arrayElementEkleme(sayilar,9);
